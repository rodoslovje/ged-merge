...
export const OVERLAY_PRESETS: OverlayPreset[] = [
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2835, 14.3971, 46.3517, 14.4710],
    sampleZoom: 16,
  },
  {
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [45.6519, 15.3342, 45.6981, 15.3960],
    sampleZoom: 16,
  },
  {
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.1604, 14.2253, 46.1878, 14.3237],
    sampleZoom: 16,
  },
  {
  ...
  {
    key: "settings.map.overlays.preset.kataster.predoslje",
    url: "https://tiles.gedmerge.com/kataster-predoslje/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2561, 14.3725, 46.2971, 14.3972],
    sampleZoom: 16,
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2288, 14.3480, 46.2698, 14.4218],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.tupalice",
    url: "https://tiles.gedmerge.com/kataster-tupalice/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2562, 14.3971, 46.3108, 14.4464],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.sencur",
    url: "https://tiles.gedmerge.com/kataster-sencur/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2696, 14.2495, 46.2970, 14.3234],
    sampleZoom: 16,
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2561, 14.2741, 46.2834, 14.3480],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.kokrica",
    url: "https://tiles.gedmerge.com/kataster-kokrica/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2561, 14.2986, 46.3244, 14.3726],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.suha",
    url: "https://tiles.gedmerge.com/kataster-suha/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2698, 14.3725, 46.2971, 14.4218],
    sampleZoom: 16,
  },
  {
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.1805, 14.3481, 46.2016, 14.4218],
    sampleZoom: 16,
  },
  {
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.1606, 14.3727, 46.1879, 14.4219],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.toplice",
    url: "https://tiles.gedmerge.com/kataster-toplice/{z}/{x}/{y}.webp",
    yearFrom: 1824,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [45.7223, 14.9828, 45.7910, 15.0803],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.ljubljanaTrnovsko",
    url: "https://tiles.gedmerge.com/kataster-ljubljana-trnovsko/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [45.9832, 14.4220, 46.0515, 14.5200],
    sampleZoom: 16,
  },
  {
    key: "settings.map.overlays.preset.kataster.ljubljanaSvpetra",
    url: "https://tiles.gedmerge.com/kataster-ljubljana-svpetra/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
