...
export const OVERLAY_PRESETS: OverlayPreset[] = [
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.2288, 14.3726, 46.2698, 14.4218],
    sampleZoom: 16,
  },
  {
  ...
  {
    key: "settings.map.overlays.preset.kataster.jama",
    url: "https://tiles.gedmerge.com/kataster-jama/{z}/{x}/{y}.webp",
    yearFrom: 1826,
    yearTo: 1869,
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [46.1470, 14.3727, 46.1879, 14.4219],
    sampleZoom: 16,
  },
  {
  ...
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [45.9969, 14.4955, 46.0514, 14.5445],
    sampleZoom: 16,
  },
  {
    ...
    attribution: "Arhiv Republike Slovenije, SI AS 176 (Franciscejski kataster za Kranjsko)",
    maxZoom: 18,
    coverage: [45.7223, 14.9829, 45.7910, 15.0803],
    sampleZoom: 16,
  },
  {
...
}coverage: [45.9965, 14.4955, 46.0514, 14.5445]import type { MapOverlay } from "../SettingsContext";
