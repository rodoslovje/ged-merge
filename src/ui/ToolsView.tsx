...
import { useToolsScans, type ToolsScans } from "./useToolsScans";
...
function NormalizePanel({ dataset, scans, fileName, active }: { dataset: Dataset; scans: ToolsScans; fileName: string; active: boolean }) {
  const { t } = useTranslation();
