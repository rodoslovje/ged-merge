export const en = {
  ...
  "settings.map.basemap.hint": "The background every map draws on. All of these need no account, and the credit shown on the map and burned into exported images follows your choice. OpenStreetMap names the most hamlets and farms, the terrain map shows the valleys and ridges between parishes, and the satellite view tells you whether the house still stands.",
  ...
  "settings.map.tileUrl.hint": "An XYZ tile URL template with {z}/{x}/{y} placeholders. Its terms and attribution are yours to honour — the map credits nothing for it.",
