export const en = {
  ...
  "tools.validate.fixOneLinkHint": "Removes this one broken pointer from the record. You can undo it.",
  "tools.validate.fixOneDone": "Done",
  "tools.validate.fixOneValue": "→ {{value}}",
  "tools.validate.fixOneSexHint": "Sets this person's sex from their family role. You can undo it.",
  "tools.validate.fixOneRoleHint": "Puts this couple back in their own roles, husband and wife exchanged. You can undo it.",
  "tools.validate.fixOneDup": "Remove duplicate",
  "tools.validate.fixOneDupHint": "Removes this record's repeated pointer lines, keeping one of each. You can undo it.",
  "tools.validate.fixOneDangling": "Remove reference",
  "tools.validate.fixOneDanglingHint": "Removes this record's pointers to the missing record. You can undo it.",
  ...
  "tools.duplicates.cluster.mergeAllTip": "Collapse this whole group into one record (undoable)",
  ...
  "tools.duplicates.cluster.mergeAllBody": "Each record is folded into the one you keep, with the usual defaults: a value only one side has is taken, the more precise date wins, and a disagreement keeps the surviving record. The whole thing undoes in one step.",
  ...
  "tools.batch.intro": "Stack filters to select people across the whole file, review the matches, then apply one action to all of them in a single undoable step. Save a filter (with its action) to re-run the same chore later — the saved list always shows how many people currently match.",
  ...
  "tools.batch.confirm_one": "Apply to {{count}} person? One undo step reverses it.",
  "tools.batch.confirm_other": "Apply to {{count}} people? One undo step reverses it.",
  ...
  "tools.sources.dupIntro": "Records that describe the same media, source or repository under different ids. Pick the groups to merge and apply: each group is collapsed to one record in your file and every citation re-pointed onto it, in one undoable step.",
