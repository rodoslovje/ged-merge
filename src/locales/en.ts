export const en = {
  ...
  "tools.tool.geocode": "Geocode places",
  "tools.tool.geocode.desc": "Match places to coordinates for the Map chart",
  ...
  "map.emptyHint": "The map plots events whose place carries a MAP coordinate (LATI/LONG). Add them with Tools → Geocode places, or load a file from webtrees, MacFamilyTree and similar programs that write them.",
