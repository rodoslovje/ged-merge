export const en = {
  ...
  "export.sheets": "PDF in sheets (print)",
  "export.sheets.tooltip": "Cut a diagram too wide for one page into page-sized sheets, and print the set",
  "sheets.title": "Print in sheets",
  "sheets.intro": "A diagram too wide for one page is cut at its branches. Each branch that doesn't fit carries on over its own sheet, and a numbered circle marks where it was cut off.",
  "sheets.paper": "Paper",
  "sheets.paper.a4": "A4",
  "sheets.paper.a3": "A3",
