export const en = {
  ...
  "tools.registerAddr.take": "Use official spelling",
  "tools.registerAddr.move": "register: {{place}}",
  "tools.registerAddr.moveHint": "Move these events on the Addresses tab, where the map can confirm the house before anything is written.",
  ...
  "tools.register.dismissHint": "Accept this place as written and keep it off the list — remembered in this browser, never written to the file",
  "tools.register.undismissHint": "Put this place back on the list",
  "tools.register.showDismissed": "Show dismissed",
  "tools.register.showDismissedHint": "Places you have accepted as written — historical names, mostly. Tick to list them again.",
