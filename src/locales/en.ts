export const en = {
  ...
  "tools.places.coord": "Coordinate written in the file for this place — click to map it",
  "tools.places.coord.disputed": "The file puts this place in more than one spot — click to map them",
