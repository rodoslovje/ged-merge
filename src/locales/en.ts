export const en = {
  ...
  "tools.validate.issue.island": "One of {{count}} people who connect to nobody else in the file. This is the youngest of them — open them and walk the group's relatives to find where it belongs.",
  ...
  "tools.validate.issue.multipleParents": "Is a birth child in {{count}} families at once — {{families}}. Only one can be the birth family: remove the wrong link, merge the duplicated parents, or mark the other as adopted or foster.",
  ...
  "tools.places.coord.spots": "{{count}} spots",
  "tools.places.coord.spotUses": "{{count}} mention",
  "tools.places.coord.spotUses_other": "{{count}} mentions",
  "tools.places.coord.disputedNote": "This place is written at {{count}} different spots.",
