export const en = {
  ...
  "settings.map.overlays": "Historical overlay layers",
  "settings.map.overlays.hint": "Extra tile layers the Map chart can draw over the base map — e.g. a georeferenced historical survey. Layers whose period matches the map's selected years are suggested there. Subscription sources (e.g. Arcanum/Mapire) work with the tile URL from your account.",
  ...
  "settings.map.overlays.preset.gurs.topo": "Slovenia · Topographic map 1:50 000 → 1:5000 (GURS)",
