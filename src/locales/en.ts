export const en = {
  ...
  "sourceLayout.pageMedia.event": "page images on persons/events",
  ...
  "sourceLayout.pageMedia.source": "page images on sources",
  ...
  "settings.format.title": "GEDCOM format",
  "settings.format.hint":
    "How your file writes each convention. \"Detected\" follows the file's own majority habit; a chosen value is enforced by the compare-file normalizer, Organize sources, Add Source and editing. Date, place, name and link choices apply from the next file load.",
  "settings.format.detected": "Detected",
  "settings.format.date": "Dates",
  "settings.format.date.hint": "Layout for written dates, e.g. 15 JUN 1879 or 15.6.1879.",
  "settings.format.datePlaceholder": "Unknown date parts",
  ...
  "settings.format.sourceLayout": "Source records",
  ...
  "settings.format.pageMedia": "Register page images",
  ...
  "settings.format.pageMedia.event": "on events",
  "settings.format.pageMedia.source": "on the source only",
