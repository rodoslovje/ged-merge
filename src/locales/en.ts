export const en = {
  ...
  "tools.duplicates.mergeConfirmAlso": "The relatives you ticked ({{names}}) are merged first, each keeping its left record.",
  "tools.duplicates.mergeConfirmAlsoAfter": "The children you ticked ({{names}}) are merged afterwards, each keeping its left record.",
