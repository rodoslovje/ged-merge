export const en = {
  ...
  "settings.map.tiles.hint": "The Map chart fetches its street-map background from the tile provider; requests reveal the viewed region. Off = the built-in offline outline.",
