export const en = {
  ...
  "settings.map.overlays.preset.gurs.ortho": "Slovenia · Orthophoto 0.25 m (GURS)",
  "settings.map.overlays.preset.gurs.ortho50": "Slovenia · Orthophoto 0.5 m (GURS)",
  "settings.map.overlays.preset.gurs.topo50": "Slovenia · Topographic map 1:50 000 (GURS)",
  "settings.map.overlays.preset.gurs.topo5": "Slovenia · Topographic plan 1:5000 (GURS)",
