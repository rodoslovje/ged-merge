export const en = {
  ...
  "tools.validate.coordConflict.apply": "Use this coordinate for all {{count}} events",
  ...
  "tools.geocode.apply": "Write {{count}} coordinates",
  ...
  "tools.geocode.online.search": "Search online (OpenStreetMap)",
  ...
  "tools.geocode.gov.search": "Search GOV",
  ...
  "tools.geocode.addr.apply": "Write {{count}} address coordinate",
  "tools.geocode.addr.apply_other": "Write {{count}} address coordinates",
  ...
  "tools.geocode.addr.moveApply": "Move",
  "tools.geocode.addr.moved": "Moved — {{count}} record updated.",
  "tools.geocode.addr.moved_other": "Moved — {{count}} records updated.",
  "tools.geocode.addr.splitFound": "{{count}} address here ({{events}} events) is in {{settlement}} according to the register, not {{place}}.",
  "tools.geocode.addr.splitFound_other": "{{count}} addresses here ({{events}} events) are in {{settlement}} according to the register, not {{place}}.",
