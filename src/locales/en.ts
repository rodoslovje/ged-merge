export const en = {
  ...
  "tools.sources.dupApplyCount": "merge {{groups}} duplicate groups · remove {{records}} records",
  ...
  "tools.sources.reshapeApplyCount": "convert {{groups}} link groups · {{citations}} citations",
