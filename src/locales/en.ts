export const en = {
  ...
  "tools.places.geocodeBack": "Places",
  ...
  "tools.geocode.coverage": "{{covered}} of {{total}} place references carry coordinates · {{distinct}} distinct place names to resolve.",
  "tools.geocode.applied": "Updated {{count}} records.",
  "tools.geocode.selectConfident": "Select confident ({{count}})",
  "tools.geocode.clearSelection": "Clear selection",
  ...
  "tools.geocode.downloadBtn": "Download from GeoNames",
  "tools.geocode.countryCodePlaceholder": "SI",
  "tools.geocode.countryCodeTooltip": "Two-letter country code (SI, AT, HR, DE, …)",
  "tools.geocode.downloadFailed": "The download did not go through — download the file from the site below and import it here.",
  "tools.geocode.downloadNeedsOptIn": "Direct download appears here once online lookups are allowed in Settings → Advanced.",
