export const en = {
  ...
  "settings.links.fetch.hint": "One switch for every lookup that leaves your device: a source's page title when you add it from a bare URL, and the geocoding searches — OpenStreetMap, Slovenia's GURS address register and gazetteer, and GOV. Off by default.",
  "settings.links.fetch.relays": "Only the page-title lookup goes through a public relay, tried in this order:",
  "settings.links.fetch.relaysNote": "The geocoding services are called directly. Either way only the address being looked up is sent — never your file.",
